...
fn execute() {
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "Event { thread_id: ThreadId(1), kind: WillExecute { database_key: tracked_fn(Id(0)) } }",
            "Event { thread_id: ThreadId(1), kind: WillCheckCancellation }",
            "Event { thread_id: ThreadId(1), kind: WillExecute { database_key: tracked_fn(Id(1)) } }",
        ]"#]]);
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "Event { thread_id: ThreadId(1), kind: WillCheckCancellation }",
            "Event { thread_id: ThreadId(1), kind: DidValidateMemoizedValue { database_key: tracked_fn(Id(0)) } }",
            "Event { thread_id: ThreadId(1), kind: WillCheckCancellation }",
            "Event { thread_id: ThreadId(1), kind: DidValidateMemoizedValue { database_key: tracked_fn(Id(1)) } }",
        ]"#]]);
}
